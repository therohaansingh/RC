$(document).ready(function () {
  ...
  gsap.set(".anime-card-front img", {
    attr: { src: "https://rhnsin1.000webhostapp.com/RCimg/strategy.jpg" }
  });
  gsap.set(".anime-card-back img", {
    attr: { src: "https://rhnsin1.000webhostapp.com/RCimg/design.jpg" }
  });
  ...
  gsap.to(".anime-card-front img", {
    attr: {
      src: "https://rhnsin1.000webhostapp.com/RCimg/coding.jpg"
    },
    scrollTrigger: {
      trigger: ".banner-three",
      start: "top bottom",
  ...
  gsap.to(".anime-card-back img", {
    attr: { src: "https://rhnsin1.000webhostapp.com/RCimg/deploy.jpg" },
    scrollTrigger: {
      trigger: ".banner-four",
      start: "top bottom",
      end: "top bottom",
